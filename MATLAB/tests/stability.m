%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
% stability for testing ODE solver stability
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Clear and close all
...
sim = Simulation(blocks, connections, ...
                 ...
                 'logs_info', containers.Map({'output'}, ...
                                             {[1, 1]}), ...
                 'restart', true);
%
% Run simulation
...
fig = figure();
ax = axes(fig);
plot(ax, logs_out1('output').time, logs_out1('output').data, ...
     'LineWidth', 1.5, ...
     'DisplayName', 'Euler Forward');
hold(ax, 'on');
plot(ax, logs_out2('output').time, logs_out2('output').data, ...
     'LineWidth', 1.5, ...
     'DisplayName', 'Runge Kutta 4');
plot(ax, logs_out3('output').time, logs_out3('output').data, ...
     'LineWidth', 1.5, ...
